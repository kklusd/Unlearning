...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str, default='run/0model_SA_best.pth.tar', help="the path of original model")
    ...
    parser.add_argument("--mask_path", default='salUN/run/saved_models/with_0.5.pt', type=str, help="the path of saliency map")
